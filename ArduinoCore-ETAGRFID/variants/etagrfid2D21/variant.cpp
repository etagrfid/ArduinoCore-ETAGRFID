...
const PinDescription g_APinDescription[]=
{
 ...
 // 34 - Alternate use of A0 (DAC output)
  ...
  // pins 48 - 49 
  { PORTB, 16, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0 }, // STBY 1
  { PORTB, 17, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1 }, // STBY 2
